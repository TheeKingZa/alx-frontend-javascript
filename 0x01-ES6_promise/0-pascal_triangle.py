...
def pascal_triangle(n):
    ...
    Returns:
        list: A list of lists representing Pascal's triangle up to the nth row.
              Each inner list contains the elements of a single row of the triangle.
    ...
    for i in range(1, n):
        ...
        for j in range(1, i):
            # Calculate the value for each element in the row using the values from the previous row
...
if __name__ == "__main__":
    print_triangle(pascal_triangle(5))  # Print Pascal's triangle up to the 5th row
